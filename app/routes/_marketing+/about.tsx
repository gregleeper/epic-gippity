...
import { Heading, Lead, Subheading } from '#app/components/text.tsx'
import company1 from '../../screenshots/company/1.jpg'
import company2 from '../../screenshots/company/2.jpg'
import company3 from '../../screenshots/company/3.jpg'
import company4 from '../../screenshots/company/4.jpg'
...
function Header() {
	return (
		<Container className="mt-16">
			<Heading as="h1">
				Helping educators get the most out of their time.
			</Heading>
			<Lead className="mt-6 max-w-3xl">
				...
				leverages AI-driven analytics, adaptive learning tools, and automation
				to enhance student engagement, personalize learning paths, and save
				valuable time for educators.
			</Lead>
			<section className="mb-24 mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
				<div className="max-w-lg">
					<h2 className="text-2xl font-medium tracking-tight">Our mission</h2>
					<p className="mt-6 text-sm/6 text-gray-600">
						At Prosper Education, we are dedicated to transforming the way
						educators teach and students learn. Our mission is to provide
						educators with the tools and resources they need to create a more
						engaging and personalized learning experience for their students.
					</p>
					<p className="mt-8 text-sm/6 text-gray-600">
						We are customer-obsessed — we put the time in to build a detailed
						understanding of the needs of educators and students so that we can
						create a more engaging and personalized learning experience for
						students.
					</p>
				</div>
