...
INSERT INTO "new_Summary" ("createdAt", "id", "instanceId", "lessonPlanId", "model", "rubricId", "summary", "updatedAt", "userId") SELECT "createdAt", "id", "instanceId", "lessonPlanId", "model", "rubricId", "summary", "updatedAt", "userId" FROM "Summary";
DROP TABLE "Summary";
