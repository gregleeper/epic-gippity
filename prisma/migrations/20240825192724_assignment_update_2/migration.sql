...
INSERT INTO "new_Assignment" ("createdAt", "description", "gradeLevel", "id", "requirements", "rubricId", "title", "updatedAt", "userId", "userRubricId") SELECT "createdAt", "description", "gradeLevel", "id", "requirements", "rubricId", "title", "updatedAt", "userId", "userRubricId" FROM "Assignment";
